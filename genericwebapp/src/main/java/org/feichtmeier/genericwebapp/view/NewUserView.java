...
public class NewUserView extends AbstractView implements Styleable, UserFilter {
    ...
    public NewUserView(UserRepository userRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder) {
